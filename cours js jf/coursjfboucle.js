...
const paragTablo = Array.from(allParag); //!transforme en tableaux
...
const userData = { //creation objet
    name: 'John Doe',   //clef : valeurs
...
//! Pour accèder aux valeurs correspondantes aux clés utilisez la notation en tableau associatif (entre crochet) 👇
